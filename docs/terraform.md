...
| <a name="input_permissions_boundary"></a> [permissions\_boundary](#input\_permissions\_boundary) | If provided, IAM role will be created with this permissions boundary attached | `string` | `null` | no |
