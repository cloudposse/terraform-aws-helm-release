...
| <a name="requirement_helm"></a> [helm](#requirement\_helm) | >= 2.2, < 3.0 |
| <a name="requirement_kubernetes"></a> [kubernetes](#requirement\_kubernetes) | >= 2.7.1, < 3.0 |

## Providers

| Name | Version |
| ---- | ------- |
| <a name="provider_helm"></a> [helm](#provider\_helm) | >= 2.2, < 3.0 |
| <a name="provider_kubernetes"></a> [kubernetes](#provider\_kubernetes) | >= 2.7.1, < 3.0 |
...
Copyright © 2021-2022-2026 [Cloud Posse, LLC](https://cloudposse.com)
